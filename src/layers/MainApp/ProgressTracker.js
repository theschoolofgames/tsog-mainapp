...
var ProgressTrackerLayer = cc.LayerColor.extend({
    ...
    _filterGameObjectJSON: function(key, key2) {
        ...
        cc.loader.loadJson(res.Game_Object_JSON, function(err, data) {
            ...
            console.log("Aray Object:  => " + JSON.stringify(self.gameObjectJson));
        });
    ...
    _onPressed: function(button) {
        ...
        this._currentButton.setLocalZOrder(1);
    ...
    addGetUpdatesBtn: function() {
        ...
        var btnTitle = (hasGrantPermission) ? "Stop Updates" : "Get Updates";
        ...
        b.addClickEventListener(function() {
            ...
            if (!hasGrantPermission) {
                ...
                this.getUpdatesBtnTitle.setString("Stop Updates");
            } else {
                ...
                this.getUpdatesBtnTitle.setString("Get Updates");
            }
        }.bind(this));
